...
void merge(char *v[], int startLeft, int startRight, int endRight){
    ...
    int nElems = endRight-startLeft+1;
    char *aux[nElems];

    int indexLeft = startLeft ;
    int indexRight = startRight ;
...
void mergeSort(char* v[], int indexStart, int indexEnd){
    ...
    mergeSort(v, indexStart, indexMiddle);
    mergeSort(v, indexMiddle+1, indexEnd);
